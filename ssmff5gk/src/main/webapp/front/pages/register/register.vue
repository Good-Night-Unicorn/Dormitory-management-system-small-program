<template>
	<view class="content">
		...
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.xuehao" type="text" class="uni-input" name="" placeholder="学号" />
		</view>
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.xueshengxingming" type="text" class="uni-input" name="" placeholder="学生姓名" />
		</view>
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
                        <picker @change="xueshengbanjiChange" :value="xueshengbanjiIndex" :range="xueshengbanjiOptions">
                                <view :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' class="uni-input">{{ruleForm.banji?ruleForm.banji:"请选择班级"}}</view>
                        </picker>
                </view>
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
		...
		<view v-if="tableName=='xuesheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"rgba(242, 199, 68, 1)","backgroundColor":"#fff","borderRadius":"32rpx","color":"#333","textAlign":"left","borderWidth":"4rpx 4rpx 4rpx 4rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}' v-model="ruleForm.sushehao" type="text" class="uni-input" name="" placeholder="宿舍号" />
		</view>
		<view>
