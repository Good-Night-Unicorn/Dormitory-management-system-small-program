<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="晚归原因" prop="wanguiyuanyin">
          <el-input v-model="ruleForm.wanguiyuanyin" 
              placeholder="晚归原因" clearable  :readonly="ro.wanguiyuanyin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="晚归原因" prop="wanguiyuanyin">
              <el-input v-model="ruleForm.wanguiyuanyin" 
                placeholder="晚归原因" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="晚归时间" prop="wanguishijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.wanguishijian" label="晚归时间" prop="wanguishijian">
              <el-input v-model="ruleForm.wanguishijian" 
                placeholder="晚归时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
